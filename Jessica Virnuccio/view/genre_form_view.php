    ...
    <div class="card-body">
       ...
       <form method="post" action="<?= $_SERVER['PHP_SELF'] ?>">
           <div class="form-group">
               ...
               <input placeholder="Aggiungi Nome Genere" id="name" value="<?= $genere->name ?>" class="form-control" type="text" name="genre_name">
               ...
               <input placeholder="Aggiungi Codice" id="name" value="<?= $genere->code ?>" class="form-control" type="text" name="genre_code">
