...
<?php View::render('jumbotron', ['lead' => "elenco degli artisti", 'site_name' => "Playlist Vincenzo"]); ?>
        ...
        <tbody>
            ...
            <?php foreach ($artisti as  $artista) { ?>
                ...
                <tr>
                    ...
                    <td class="text-center"><a href="<?= Config::SITE_URL.'controller/artist_delete_controller.php?id='.$artista->artist_id ?>" class="text-danger">delete</a>
                    </td>
                </tr>
